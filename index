...
<body>
    ...
    <div id="reader"></div>
    <div class="scan-overlay" id="scan-box"></div> <div id="feedback-overlay">
    ...
    <div id="controls-panel">
        ...
        <div class="panel-content">
            ...
            <div id="view-dashboard" class="tab-content text-center">
                ...
                <div class="bg-slate-900 p-4 rounded-xl border border-slate-700 mb-4"><h3 class="text-xs font-bold text-gray-400 uppercase mb-3"><i class="ri-pulse-line"></i> Ritmo</h3><div style="height: 150px;"><canvas id="rhythmChart"></canvas></div></div>
            ...
            <div id="view-inventario" class="tab-content"><h2 class="text-xl font-bold mb-4">Carregar Inventário</h2><div id="inventory-zones-list" class="space-y-3"></div><input type="file" id="inventory-file-input" class="hidden" accept=".xlsx,.csv,.pdf,.txt,.html"></div>
            <div id="view-zonas" class="tab-content"><h2 class="text-xl font-bold mb-4">Selecionar Zona Ativa</h2><div id="zones-list" class="space-y-3"></div></div>
            <div id="view-log" class="tab-content"><h2 class="text-xl font-bold mb-4">Histórico</h2><div id="scan-log-list" class="space-y-2"></div></div>
        </div>
    </div>
    ...
    <script>
        const CONFIG = { STORAGE_KEY: 'natefy_ultimate_v17', WEBHOOK: 'https://mrxnxtxhxn-creator.app.n8n.cloud/webhook-test/df5b4afe-2fc4-4692-a80f-257aca92edf9' };
        ...
        // --- SCANNER ---
        function startScanner() { if(state.html5QrCode) return; state.html5QrCode = new Html5Qrcode("reader"); state.html5QrCode.start({ facingMode: "environment" }, { fps: state.settings.fps, qrbox: 300 }, (d) => processScan(d)).catch(err => console.log(err)); }
